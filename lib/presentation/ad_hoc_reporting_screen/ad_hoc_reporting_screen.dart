                ...
                child: Obx(
                  () => ListView.separated(
                    ...
                    itemCount: controller.adHocReportingModelObj.value
                        .listgroup977ItemList.value.length,
                    itemBuilder: (context, index) {
                      Listgroup977ItemModel model = controller
                          .adHocReportingModelObj
                          .value
                          .listgroup977ItemList
                          .value[index];
              ...
              Padding(
                ...
                child: Obx(
                  () => ListView.separated(
                    ...
                    itemCount: controller.adHocReportingModelObj.value
                        .listtext1ItemList.value.length,
                    itemBuilder: (context, index) {
                      Listtext1ItemModel model = controller
                          .adHocReportingModelObj
                          .value
                          .listtext1ItemList
                          .value[index];
